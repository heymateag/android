...
/** This is an auto generated class representing the ReservedTimeSlot type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "ReservedTimeSlots", authRules = {
  @AuthRule(allow = AuthStrategy.PUBLIC, operations = { ModelOperation.CREATE, ModelOperation.UPDATE, ModelOperation.DELETE, ModelOperation.READ })
})
public final class Reservation implements Model {
  public static final QueryField ID = field("ReservedTimeSlot", "id");
  public static final QueryField OFFER_ID = field("ReservedTimeSlot", "offerId");
  public static final QueryField TIME_SLOT_ID = field("ReservedTimeSlot", "timeSlotId");
  public static final QueryField START_TIME = field("ReservedTimeSlot", "startTime");
  public static final QueryField END_TIME = field("ReservedTimeSlot", "endTime");
  public static final QueryField REFERRAL_ID = field("ReservedTimeSlot", "referralId");
  public static final QueryField REFERRERS = field("ReservedTimeSlot", "referrers");
  public static final QueryField SERVICE_PROVIDER_ID = field("ReservedTimeSlot", "serviceProviderId");
  public static final QueryField SERVICE_PROVIDER_FCM_TOKEN = field("ReservedTimeSlot", "serviceProviderFCMToken");
  public static final QueryField CONSUMER_ID = field("ReservedTimeSlot", "consumerId");
  public static final QueryField CONSUMER_FCM_TOKEN = field("ReservedTimeSlot", "consumerFCMToken");
  public static final QueryField STATUS = field("ReservedTimeSlot", "status");
  ...
  private Reservation(String id, String offerId, String timeSlotId, Integer startTime, Integer endTime, String referralId, String referrers, String serviceProviderId, String serviceProviderFCMToken, String consumerId, String consumerFCMToken, String status) {
    this.id = id;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String offerId, String timeSlotId, Integer startTime, Integer endTime, String referralId, String referrers, String serviceProviderId, String serviceProviderFcmToken, String consumerId, String consumerFcmToken, String status) {
      super.id(id);
