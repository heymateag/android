...
public final class Referral implements Model {
  ...
  public static final QueryField REFERRERS = field("Referral", "referrers");
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), referral.getId()) &&
              ObjectsCompat.equals(getOfferId(), referral.getOfferId()) &&
              ObjectsCompat.equals(getReferrers(), referral.getReferrers());
      }
  }
   ...
   */
  public static Referral justId(String id) {
    try {
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String offerId, String referrers) {
      super.id(id);
