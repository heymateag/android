                ...
                for (int a = 0; a < 2; a++) {
                    ...
                    if (message != null) {
                        ...
                        if (dialog != null && dialog.last_message_date != 0) {
                            ((TextView) cells[a].findViewById(works.heymate.beta.R.id.shortcut_widget_item_time)).setText(LocaleController.stringForMessageListDate(dialog.last_message_date));
                        } else {
                    ...
                    if (dialog != null && dialog.unread_count > 0) {
                        ((TextView) cells[a].findViewById(works.heymate.beta.R.id.shortcut_widget_item_badge)).setText(String.format("%d", dialog.unread_count));
                        cells[a].findViewById(works.heymate.beta.R.id.shortcut_widget_item_badge).setVisibility(VISIBLE);
