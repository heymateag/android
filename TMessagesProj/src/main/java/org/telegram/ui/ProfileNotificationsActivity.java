        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                ...
                case 1: {
                    ...
                    SharedPreferences preferences = MessagesController.getNotificationsSettings(currentAccount);
                    if (position == soundRow) {
                        String value = preferences.getString("sound_" + dialog_id, LocaleController.getString("SoundDefault", works.heymate.beta.R.string.SoundDefault));
                        ...
                        String value = preferences.getString("ringtone_" + dialog_id, LocaleController.getString("DefaultRingtone", works.heymate.beta.R.string.DefaultRingtone));
                        if (value.equals("NoSound")) {
                            value = LocaleController.getString("NoSound", works.heymate.beta.R.string.NoSound);
                        }
                ...
                case 8: {
                    ...
                    if (position == enableRow) {
                        ...
                        checkCell.setTextAndCheck(LocaleController.getString("MessagePreview", works.heymate.beta.R.string.MessagePreview), preferences.getBoolean("content_preview_" + dialog_id, true), true);
                    }
                    break;
                }
            }
