...
public class Switch extends View {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        //info.setContentDescription(isChecked ? LocaleController.getString("NotificationsOn", works.heymate.beta.R.string.NotificationsOn) : LocaleController.getString("NotificationsOff", works.heymate.beta.R.string.NotificationsOff));
    }
}
