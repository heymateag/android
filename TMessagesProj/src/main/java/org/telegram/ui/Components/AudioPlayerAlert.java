...
public class AudioPlayerAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, DownloadController.FileDownloadProgressListener {
    ...
    public AudioPlayerAlert(final Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("AttachMusic", works.heymate.beta.R.string.AttachMusic));
        ...
        editText.setHint(LocaleController.getString("Search", works.heymate.beta.R.string.Search));
        ...
        emptyImageView.setImageResource(works.heymate.beta.R.drawable.music_empty);
    ...
    private void updateRepeatButton() {
        ...
        if (mode == 0 || mode == 1) {
            ...
            if (mode == 0 && !SharedConfig.shuffleMusic && !SharedConfig.playOrderReversed) {
                ...
                repeatButton.setContentDescription(LocaleController.getString("AccDescrRepeatOff", works.heymate.beta.R.string.AccDescrRepeatOff));
            } else {
            ...
            repeatButton.setIconColor(Theme.getColor(Theme.key_player_buttonActive));
            Theme.setSelectorDrawableColor(repeatButton.getBackground(), Theme.getColor(Theme.key_player_buttonActive) & 0x19ffffff, true);
            repeatButton.setContentDescription(LocaleController.getString("AccDescrRepeatOne", works.heymate.beta.R.string.AccDescrRepeatOne));
        }
    }
