...
public class DataUsageActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("NetworkUsage", works.heymate.beta.R.string.NetworkUsage));
        ...
        for (int a = 0; a < viewPages.length; a++) {
            ...
            viewPages[a].listView.setOnItemClickListener((view, position) -> {
                ...
                if (position == adapter.resetRow) {
                    ...
                    builder.setTitle(LocaleController.getString("ResetStatisticsAlertTitle", works.heymate.beta.R.string.ResetStatisticsAlertTitle));
                    builder.setMessage(LocaleController.getString("ResetStatisticsAlert", works.heymate.beta.R.string.ResetStatisticsAlert));
    ...
    private void updateTabs() {
        ...
        scrollSlidingTextTabStrip.addTextTab(0, LocaleController.getString("NetworkUsageMobileTab", works.heymate.beta.R.string.NetworkUsageMobileTab));
        scrollSlidingTextTabStrip.addTextTab(1, LocaleController.getString("NetworkUsageWiFiTab", works.heymate.beta.R.string.NetworkUsageWiFiTab));
        scrollSlidingTextTabStrip.addTextTab(2, LocaleController.getString("NetworkUsageRoamingTab", works.heymate.beta.R.string.NetworkUsageRoamingTab));
            ...
            switch (holder.getItemViewType()) {
                ...
                case 1: {
                    ...
                    if (position == resetRow) {
                        ...
                        textCell.setText(LocaleController.getString("ResetStatistics", works.heymate.beta.R.string.ResetStatistics), false);
                        ...
                        if (position == callsSentRow) {
                            textCell.setTextAndValue(LocaleController.getString("OutgoingCalls", works.heymate.beta.R.string.OutgoingCalls), String.format("%d", StatsController.getInstance(currentAccount).getSentItemsCount(currentType, type)), true);
                        } else if (position == callsReceivedRow) {
                            textCell.setTextAndValue(LocaleController.getString("IncomingCalls", works.heymate.beta.R.string.IncomingCalls), String.format("%d", StatsController.getInstance(currentAccount).getRecivedItemsCount(currentType, type)), true);
                            ...
                            textCell.setTextAndValue(LocaleController.getString("CallsTotalTime", works.heymate.beta.R.string.CallsTotalTime), time, false);
                            ...
                            textCell.setTextAndValue(LocaleController.getString("CountSent", works.heymate.beta.R.string.CountSent), String.format("%d", StatsController.getInstance(currentAccount).getSentItemsCount(currentType, type)), true);
                            ...
                            textCell.setTextAndValue(LocaleController.getString("CountReceived", works.heymate.beta.R.string.CountReceived), String.format("%d", StatsController.getInstance(currentAccount).getRecivedItemsCount(currentType, type)), true);
                            ...
                            textCell.setTextAndValue(LocaleController.getString("BytesSent", works.heymate.beta.R.string.BytesSent), AndroidUtilities.formatFileSize(StatsController.getInstance(currentAccount).getSentBytesCount(currentType, type)), true);
                            ...
                            textCell.setTextAndValue(LocaleController.getString("BytesReceived", works.heymate.beta.R.string.BytesReceived), AndroidUtilities.formatFileSize(StatsController.getInstance(currentAccount).getReceivedBytesCount(currentType, type)), position == callsBytesReceivedRow);
                        }
                    }
                    break;
                }
                case 2: {
                    ...
                    if (position == totalSectionRow) {
                        headerCell.setText(LocaleController.getString("TotalDataUsage", works.heymate.beta.R.string.TotalDataUsage));
                    } else if (position == callsSectionRow) {
                        headerCell.setText(LocaleController.getString("CallsDataUsage", works.heymate.beta.R.string.CallsDataUsage));
                    } else if (position == filesSectionRow) {
                        headerCell.setText(LocaleController.getString("FilesDataUsage", works.heymate.beta.R.string.FilesDataUsage));
                    } else if (position == audiosSectionRow) {
                        headerCell.setText(LocaleController.getString("LocalAudioCache", works.heymate.beta.R.string.LocalAudioCache));
                    } else if (position == videosSectionRow) {
                        headerCell.setText(LocaleController.getString("LocalVideoCache", works.heymate.beta.R.string.LocalVideoCache));
                    } else if (position == photosSectionRow) {
                        headerCell.setText(LocaleController.getString("LocalPhotoCache", works.heymate.beta.R.string.LocalPhotoCache));
                    } else if (position == messagesSectionRow) {
                        headerCell.setText(LocaleController.getString("MessagesDataUsage", works.heymate.beta.R.string.MessagesDataUsage));
                    }
                    break;
                }
                case 3: {
                    ...
                    cell.setText(LocaleController.formatString("NetworkUsageSince", works.heymate.beta.R.string.NetworkUsageSince, LocaleController.getInstance().formatterStats.format(StatsController.getInstance(currentAccount).getResetStatsDate(currentType))));
                    break;
                }
                default:
                    break;
