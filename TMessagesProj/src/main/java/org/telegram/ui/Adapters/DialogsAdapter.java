...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter {
    ...
    private static final int VIEW_TYPE_SHOP = 15;
    private static final int VIEW_TYPE_FILTER_SPACE = 16;
    ...
    public boolean isEnabled(RecyclerView.ViewHolder holder) {
        ...
        return viewType != VIEW_TYPE_FLICKER && viewType != VIEW_TYPE_EMPTY && viewType != VIEW_TYPE_DIVIDER &&
                ...
                viewType != VIEW_TYPE_FILTER_SPACE;
    }
    ...
    public int getItemViewType(int i) {
        ...
        if (i == size) {
            if (!forceShowEmptyCell && dialogsType != 7 && dialogsType != 8 && !MessagesController.getInstance(currentAccount).isDialogsEndReached(folderId) && dialogsType != (Integer.MAX_VALUE - 1)) {
        ...
        return dialogsType == Integer.MAX_VALUE - 1 ? VIEW_TYPE_SHOP : VIEW_TYPE_DIALOG;
    }
