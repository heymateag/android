...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter {
    ...
    private static final int VIEW_TYPE_FILTER_SPACE = 14;
    ...
    public boolean isEnabled(RecyclerView.ViewHolder holder) {
        ...
        return viewType != 1 && viewType != 5 && viewType != 3 && viewType != 8 && viewType != 7 && viewType != 9 && viewType != 10 && viewType != 11 && viewType != VIEW_TYPE_FILTER_SPACE;
    }
    ...
    public int getItemViewType(int i) {
        ...
        if (i == size) {
            if (!forceShowEmptyCell && dialogsType != 7 && dialogsType != 8 && dialogsType != (Integer.MAX_VALUE - 1) && !MessagesController.getInstance(currentAccount).isDialogsEndReached(folderId)) {
                return 1;
            } else if (size == 0) {
                return 5;
            } else {
