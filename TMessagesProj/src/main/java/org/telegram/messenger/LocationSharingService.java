...
public class LocationSharingService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void updateNotification(boolean post) {
        ...
        String text = String.format(str, LocaleController.getString("AttachLiveLocation", works.heymate.beta.R.string.AttachLiveLocation), param);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (builder == null) {
            ...
            builder.setSmallIcon(works.heymate.beta.R.drawable.live_loc);
            ...
            builder.addAction(0, LocaleController.getString("StopLiveLocation", works.heymate.beta.R.string.StopLiveLocation), PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 2, stopIntent, PendingIntent.FLAG_UPDATE_CURRENT));
        }
